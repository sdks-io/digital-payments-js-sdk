...
} from '../errors/stationLocatorBadRequestError';
import {
  StationLocatorForbiddenError,
} from '../errors/stationLocatorForbiddenError';
import {
  StationLocatorInternalServerError,
} from '../errors/stationLocatorInternalServerError';
import {
  StationLocatorNotFoundError,
} from '../errors/stationLocatorNotFoundError';
import {
  StationLocatorUnauthorizedError,
} from '../errors/stationLocatorUnauthorizedError';
import {
  AroundLocationArray,
...
export class StationLocatorController extends BaseController {
  ...
  async stationlocatorV1StationsGetAroundLocation(
    ...
    req.throwOn(500, StationLocatorInternalServerError, 'Internal Server Error');
