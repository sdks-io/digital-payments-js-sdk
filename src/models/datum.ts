...
import { Loc, locSchema } from './loc';
import { OpeningHour, openingHourSchema } from './openingHour';
...
export const datumSchema: Schema<Datum> = object({
  ...
  addr: ['addr', optional(string())],
  lat: ['lat', optional(number())],
  lon: ['lon', optional(number())],
  amen: ['amen', optional(array(number()))],
  fuel: ['fuel', optional(array(number()))],
  loc: ['loc', optional(lazy(() => locSchema))],
  mppStationId: ['mpp_station_id', optional(string())],
  doubleSiteId: ['double_site_id', optional(string())],
  openingHours: [
    'opening_hours',
    optional(array(lazy(() => openingHourSchema))),
  ],
