...
export interface PrepareFuelingRequestDeviceDetailsItems {
...
export const prepareFuelingRequestDeviceDetailsItemsSchema: Schema<PrepareFuelingRequestDeviceDetailsItems> = object(
  {
