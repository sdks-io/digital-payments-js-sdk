...
import { PaymentProperties, paymentPropertiesSchema } from './paymentProperties';

export interface PaymentDetailsItems {
  /**
...
export const paymentDetailsItemsSchema: Schema<PaymentDetailsItems> = object({
