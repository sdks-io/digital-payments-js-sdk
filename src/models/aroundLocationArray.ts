...
import {
  ...
  aroundLocationArrayDataItemsSchema,
} from './aroundLocationArrayDataItems';
 ...
 */
export interface AroundLocationArray {
  /** An array of station objects */
  data: AroundLocationArrayDataItems[];
}

export const aroundLocationArraySchema: Schema<AroundLocationArray> = object({
  data: ['data', array(lazy(() => aroundLocationArrayDataItemsSchema))],
});
