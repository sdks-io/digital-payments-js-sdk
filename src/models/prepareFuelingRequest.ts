...
import {
  PaymentDetailsItems,
  paymentDetailsItemsSchema,
} from './paymentDetailsItems';
import {
  PrepareFuelingRequestDeviceDetailsItems,
  prepareFuelingRequestDeviceDetailsItemsSchema,
} from './prepareFuelingRequestDeviceDetailsItems';
...
export interface PrepareFuelingRequest {
  ...
  deviceDetails?: PrepareFuelingRequestDeviceDetailsItems[];
}
...
export const prepareFuelingRequestSchema: Schema<PrepareFuelingRequest> = object(
  {
    ...
    paymentDetails: [
      'paymentDetails',
      array(lazy(() => paymentDetailsItemsSchema)),
    ],
    deviceDetails: [
      'deviceDetails',
      optional(
        array(lazy(() => prepareFuelingRequestDeviceDetailsItemsSchema))
      ),
    ],
  }
);
